...
void Camera_State::Update_State(std::istream &json_answer) {
  ...
  zoom_information.zoom_index_current_box =
      results[2].get<double>("zoomIndexCurrentBox");
  ...
  zoom_information.zoom_position_current_box =
      results[2].get<double>("zoomPositionCurrentBox");
